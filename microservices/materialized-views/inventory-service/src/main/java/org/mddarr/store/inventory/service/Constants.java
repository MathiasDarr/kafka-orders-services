...
public class Constants {
    ...
    public static String PURCHASE_COUNT_TOPIC = "purchase-count";
    public static String PURCHASE_COUNT_STORE = "purchase-count-store";

    public static String PURCHASE_EVENT_TOPIC = "purchases";
